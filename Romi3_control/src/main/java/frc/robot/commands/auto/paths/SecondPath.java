...
public class SecondPath extends PathBase {
    ...
    public SecondPath(RomiDrivetrain subsystem) throws IOException {
        ...
        Trajectory exampleTrajectory = TrajectoryGenerator.generateTrajectory(
            ...
            new Pose2d(-0.45, -0.2, Rotation2d.fromDegrees(90)),
            List.of(
                new Translation2d(-0.6, 0.1),
                new Translation2d(-0.8, 0.35),
                new Translation2d(-1, 0.35),
                new Translation2d(-1.1,0)
            ),
            new Pose2d(-0.9,-0.5, Rotation2d.fromDegrees(270)),
            getTrajectoryConfig()
        );
        //set the trajectory
